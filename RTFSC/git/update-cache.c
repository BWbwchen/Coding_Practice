...
/*
 * [BWbwchen]
 * REMEMBER active_cache sort by name
 */
...
static int add_cache_entry(struct cache_entry *ce)
{
    ...
    /*
     * [BWbwchen]
     * compare new cache(argv path) with exist cache array(active_cache)
     */
	pos = cache_name_pos(ce->name, ce->namelen);

    /*
     * [BWbwchen]
     * cache_name_compare return -next-1, if exist match
     * so -(-next-1)-1 = next
     */
    ...
    /* 
     * [BWBWchen]
     * add new cache into active_cache array
     */
    ...
    /*
     * [BWbwchen]
     * the add point is in the list (not at the end)
     * move the behide part back a entry
     */
	if (active_nr > pos)
...
static int add_file_to_cache(char *path)
{
    ...
    /*
     * [BWbwchen]
     * for the desire file, get its status
     */
    ...
    /*
     * [BWbwchen]
     * deflate the file to make new sha1
     */
...
/* 
 * [BWbwchen]
 * write the new active_cache array into .dircache/index file
 */
