...
/*
 * [BWbwchen]
 * make all cache into a formatted string, prepend a weird length hearder,
 * compressed that strings and caluclate that compressed file's SHA1
 * make a file named SHA1 (leftmost bytes is which directory) save compressed file 
 * in that file
 */
int main(int argc, char **argv)
{
	...
	for (i = 0; i < entries; i++) {
        ...
        /*
         * [BWbwchen]
         * if size is greater than Guess size
         * realloc
         */
